...
3. Name: **Social Queue**
4. Title: One idea into a week of unsent posts
...
> Save the process we just used as a skill called “queue-social”. Include sources, output format, validation, and the rule that external actions always require approval.
