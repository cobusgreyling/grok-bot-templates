...
3. Name: **BlindOracle Trust Check**
4. Title: Agent reputation and settlement-proof checker
...
> Save the process we just used as a skill called “check-agent-record”. Include sources, output format, validation, and the rule that external actions always require approval.
