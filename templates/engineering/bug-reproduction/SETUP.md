...
3. Name: **Bug Reproduction**
4. Title: Staging reproduction pack writer
...
> Save the process we just used as a skill called “reproduce-bug”. Include sources, output format, validation, and the rule that external actions always require approval.
