...
3. Name: **Changelog**
4. Title: Unreleased notes from merged PRs
...
> Save the process we just used as a skill called “draft-changelog”. Include sources, output format, validation, and the rule that external actions always require approval.
