...
3. Name: **Docs Drift**
4. Title: README and API docs vs code
...
> Save the process we just used as a skill called “detect-docs-drift”. Include sources, output format, validation, and the rule that external actions always require approval.
