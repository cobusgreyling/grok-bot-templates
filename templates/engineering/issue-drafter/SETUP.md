...
3. Name: **Issue Drafter**
4. Title: Unsent GitHub issue writer
...
> Save the process we just used as a skill called “draft-issue”. Include sources, output format, validation, and the rule that external actions always require approval.
