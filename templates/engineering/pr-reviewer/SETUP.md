...
3. Name: **PR Reviewer**
4. Title: Risk-first pull request reviewer
...
> Save the process we just used as a skill called “review-pr-risk”. Include sources, output format, validation, and the rule that external actions always require approval.
