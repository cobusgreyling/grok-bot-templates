...
3. Name: **Query Helper**
4. Title: Schema-grounded SQL drafter
...
> Save the process we just used as a skill called “draft-sql”. Include sources, output format, validation, and the rule that external actions always require approval.
