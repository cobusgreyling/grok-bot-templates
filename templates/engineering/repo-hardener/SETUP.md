...
3. Name: **Repo Hardener**
4. Title: Security and hygiene recommender
...
> Save the process we just used as a skill called “harden-repo”. Include sources, output format, validation, and the rule that external actions always require approval.
