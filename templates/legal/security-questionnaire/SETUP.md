...
3. Name: **Security Questionnaire**
4. Title: Draft answers from the pack
...
> Save the process we just used as a skill called “draft-security-answers”. Include sources, output format, validation, and the rule that external actions always require approval.
