...
3. Name: **Content Remix**
4. Title: Draft-only social and email variants
...
> Save the process we just used as a skill called “remix-content”. Include sources, output format, validation, and the rule that external actions always require approval.
