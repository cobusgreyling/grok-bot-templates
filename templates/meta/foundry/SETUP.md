...
3. Name: **Foundry**
4. Title: Grok Bot template foundry
...
> Save the process we just used as a skill called “design-bot-template”. Include sources, output format, validation, and the rule that external actions always require approval.
