...
3. Name: **Memory Gardener**
4. Title: Stale-memory corrector
...
> Save the process we just used as a skill called “garden-memory”. Include sources, output format, validation, and the rule that external actions always require approval.
