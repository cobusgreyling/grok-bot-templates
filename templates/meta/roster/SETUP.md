...
3. Name: **Roster Coach**
4. Title: Smallest-useful fleet auditor
...
> Save the process we just used as a skill called “install-team”. Include sources, output format, validation, and the rule that external actions always require approval.
