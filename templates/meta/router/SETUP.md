...
3. Name: **Fleet Router**
4. Title: One-owner work dispatcher
...
> Save the process we just used as a skill called “route-work”. Include sources, output format, validation, and the rule that external actions always require approval.
