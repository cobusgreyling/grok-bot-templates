...
3. Name: **Share Sanitizer**
4. Title: Public-share secret stripper
...
> Save the process we just used as a skill called “sanitize-share”. Include sources, output format, validation, and the rule that external actions always require approval.
