...
3. Name: **Incident Desk**
4. Title: Slack-and-GitHub incident timeline
...
> Save the process we just used as a skill called “incident-timeline”. Include sources, output format, validation, and the rule that external actions always require approval.
