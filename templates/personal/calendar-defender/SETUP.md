...
3. Name: **Calendar Defender**
4. Title: Deep-work block protector
...
> Save the process we just used as a skill called “defend-calendar”. Include sources, output format, validation, and the rule that external actions always require approval.
