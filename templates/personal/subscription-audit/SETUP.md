...
3. Name: **Subscription Audit**
4. Title: Unused-subscription watch from mail
...
> Save the process we just used as a skill called “audit-subscriptions”. Include sources, output format, validation, and the rule that external actions always require approval.
