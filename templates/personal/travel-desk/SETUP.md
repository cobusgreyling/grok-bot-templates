...
3. Name: **Travel Desk**
4. Title: Itinerary sanity without booking
...
> Save the process we just used as a skill called “plan-trip”. Include sources, output format, validation, and the rule that external actions always require approval.
