...
3. Name: **Evidence Packager**
4. Title: Ship-or-block evidence compiler
...
> Save the process we just used as a skill called “package-evidence”. Include sources, output format, validation, and the rule that external actions always require approval.
