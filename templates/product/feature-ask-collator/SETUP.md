...
3. Name: **Feature Ask Collator**
4. Title: Clustered product asks, not a roadmap
...
> Save the process we just used as a skill called “collate-feature-asks”. Include sources, output format, validation, and the rule that external actions always require approval.
