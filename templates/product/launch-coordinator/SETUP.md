...
3. Name: **Launch Coordinator**
4. Title: Go/no-go packet, never the publish
...
> Save the process we just used as a skill called “coordinate-launch”. Include sources, output format, validation, and the rule that external actions always require approval.
