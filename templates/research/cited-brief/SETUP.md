...
3. Name: **Cited Brief**
4. Title: Three-minute cited brief
...
> Save the process we just used as a skill called “cited-research”. Include sources, output format, validation, and the rule that external actions always require approval.
