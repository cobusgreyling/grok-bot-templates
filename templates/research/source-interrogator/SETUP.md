...
3. Name: **Source Interrogator**
4. Title: Assumption hunter for briefs and memos
...
> Save the process we just used as a skill called “interrogate-assumptions”. Include sources, output format, validation, and the rule that external actions always require approval.
