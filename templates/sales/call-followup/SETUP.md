...
3. Name: **Call Follow-up**
4. Title: Unsent recap and tasks after a call
...
> Save the process we just used as a skill called “draft-call-followup”. Include sources, output format, validation, and the rule that external actions always require approval.
