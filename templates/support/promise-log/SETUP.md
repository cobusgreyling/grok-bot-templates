...
3. Name: **Promise Log**
4. Title: Customer commitments, written down
...
> Save the process we just used as a skill called “log-promises”. Include sources, output format, validation, and the rule that external actions always require approval.
