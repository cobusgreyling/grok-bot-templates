...
3. Name: **Support Replies**
4. Title: Policy-cited first-response drafts
...
> Save the process we just used as a skill called “draft-support-reply”. Include sources, output format, validation, and the rule that external actions always require approval.
